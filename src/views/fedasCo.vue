...
import { cardsData } from '../assets/fedasCo/cardsData'
...
<template>
  <div class="container">
    ...
    <div class="container-text">
      ...
      <p>
        At F&F Engineering Co Ltd, our commitment to excellence in engineering knows no bounds. With
        a proud legacy spanning over four decades, we have continually evolved and adapted to meet
        the ever-changing needs of the engineering industry. Our dedication to quality, innovation,
        and customer satisfaction has solidified our position as a trusted leader in the field.
      </p>
    </div>
  </div>
...
.container {
  position: relative;
  background-image: url('../../public/tractor4.jpeg'); /* Replace with your background image path */
...
.background-image {
  background-image: url('tractor1.jpeg');
  background-size: cover;
